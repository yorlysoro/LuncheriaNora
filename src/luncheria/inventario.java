...
public class inventario extends javax.swing.JFrame {
     ...
     */
    public inventario(basedatos bd) {
        initComponents();
        BitacoraVentanas.LOG_RAIZ.log(Level.INFO, "Iniciando la ventana inventario");

        this.bd = bd;
        this.setLocationRelativeTo(null);
        this.tabla  =(DefaultTableModel) tablaInventario.getModel();
        Cargar_Tabla();
    }
    ...
    private void initComponents() {
        ...
        tablaInventario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo","Nombre", "Descripcion", "Precio", "Categoria", "Cantidad", "Estado"
            }
        ));
    ...
    private void JBtn_salirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtn_salirActionPerformed
       BitacoraVentanas.LOG_RAIZ.log(Level.INFO, "Saliendo de la ventana Inventario");
    ...
    private void Cargar_Tabla() {
        try{
            this.bd.Conectar();
            this.bd.setResult("SELECT * FROM productos");
            ...
            while(result.next()){
                ...
                switch(result.getString(5)){
                    case "1" : Datos[4] = "Comida"; break;
                    case "2" : Datos[4] = "Bebidas"; break;
                    case "3" : Datos[4] = "Golosinas"; break;
                }                
                Datos[5] = (""+result.getString(6));
                switch(result.getString(7)){
                    case "1" : Datos[6] = "Activo"; break;
                    case "0" : Datos[6] = "Inactivo"; break;
